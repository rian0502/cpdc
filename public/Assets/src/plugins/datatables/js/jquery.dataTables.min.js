...
$jscomp.polyfill = function (f, z, y, p) {
  if (z) {
    ...
    z != p &&
      null != z &&
      $jscomp.defineProperty(y, f, { configurable: !0, writable: !0, value: z });
  }
};
$jscomp.polyfill(
...
(function (f) {
  ...
  var q = function (a) {
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          g.bStateSave
            ? ((C.bStateSave = !0), E(r, "aoDrawCallback", Ba, "state_save"), Ob(r, g, e))
            : e();
        }
      });
      b = null;
  ...
  t("draw()", function (a) {
    return this.iterator("table", function (b) {
      "page" === a
        ? S(b)
        : ("string" === typeof a && (a = "full-hold" === a ? !1 : !0), V(b, !1 === a));
    });
  });
  t("page()", function (a) {
    return a === p
  ...
  var hc = function (a, b, c, d) {
    ...
    Yb = function (a, b) {
      ...
      c.length &&
        ...
        ((a = c[0].aoData[a[0]]),
        a._details &&
          ((a._detailsShow = b) ? a._details.insertAfter(a.nTr) : a._details.detach(), ic(c[0])));
    },
    ic = function (a) {
      var b = new v(a),
        c = a.aoData;
