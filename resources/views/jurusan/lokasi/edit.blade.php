                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@error('jenis_ruangan') form-control-danger @enderror">
                                        <div class="custom-control custom-radio custom-control-inline pb-0">
                                            <input type="radio" id="Lab" name="jenis_ruangan" value="Lab"
                                                class="custom-control-input"
                                                {{ old('jenis_ruangan', $lokasi->jenis_ruangan) == 'Lab' ? 'checked' : '' }} />
                                            <label class="custom-control-label" for="Lab">Laboratorium</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline pb-0">
                                            <input type="radio" id="Kelas" name="jenis_ruangan" value="Kelas"
                                                class="custom-control-input"
                                                {{ old('jenis_ruangan', $lokasi->jenis_ruangan) == 'Kelas' ? 'checked' : '' }} />
