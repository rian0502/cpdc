            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-8 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        ...
                        <ul class="team-social">
                            ...
                            <li><a class="btn btn-square" href="https://www.linkedin.com/in/muhammad-febrian-hasibuan/"
                ...
                <div class="col-lg-4 col-md-8 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        ...
                        <ul class="team-social">
                            <li><a class="btn btn-square" href="https://www.linkedin.com/in/yogi-andaru/" target="_blank"><i
                                        class="fab fa-linkedin-in"></i></a></li>
                        </ul>
                    </div>
                </div>
