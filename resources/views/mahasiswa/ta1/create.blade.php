                        ...
                        <div class="profile-edit-list row">
                            ...
                            <div class="kanan weight-500 col-md-6">
                                ...
                                <div class="form-group" id="form-mobile">
                                    ...
                                    <option value="Dosen" {{old('sumber_penelitian')=='Dosen' ? 'selected' : ''}}>Peneltian Dosen</option>
                                    <option value="Mahasiswa" {{old('sumber_penelitian')=='Mahasiswa' ? 'selected' : ''}}>Non Peneltian Dosen</option>
                                    </select>
