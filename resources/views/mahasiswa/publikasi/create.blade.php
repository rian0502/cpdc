        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="{{ route('mahasiswa.publikasi.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="kanan weight-500 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kategori" id="kategori" class="selectpicker form-control">
                                        ...
                                        <option value="Paten" {{ old('kategori') == 'Paten' ? 'selected' : '' }}>
                                            Paten</option>
                                        <option value="Paten Sederhana"
                                            {{ old('kategori') == 'Paten Sederhana' ? 'selected' : '' }}>
                                            Paten Sederhana</option>
                                        <option value="Hak Cipta" {{ old('kategori') == 'Hak Cipta' ? 'selected' : '' }}>
                                            Hak Cipta</option>
                                ...
                                <div class="form-group">
                                    <label>Anggota</label>
                                    <textarea value="{{ old('anggota') }}" autofocus name="anggota" id="anggota"
                                        placeholder='contoh: &#10;Dr. John Doe, &#10;Prof. Jane Smith, &#10;Dr. Michael Johnson,'
                                        class="form-control @error('anggota') form-control-danger @enderror" type="text"></textarea>
                                    @error('anggota')
                                        <div class="form-control-feedback has-danger">{{ $message }}</div>
                                    @enderror
                                </div>
