                    ...
                    <div class="">
                        <div class="pl-3 pr-3 pb-0 mb-2 bg-light text-dark rounded-div">
                            ...
                            <div class="row border-bottom mt-2">
                                ...
                                <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                    <a target="_blank"
                                        href="/uploads/syarat_seminar_ta1/">Lihat
                                        Berkas</a>
                                </div>
                            </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="bukti_seminar">
                    <div class="pl-3 pr-3 pb-0 mb-2 bg-light text-dark rounded-div">
                        ...
                        <div class="row border-bottom mt-2">
                            <label class="col-md-3 bold"> <strong>Laporan Final TA 2</strong></label>
                            <div class="col-md-3" style="display:block;word-wrap:break-word;">
                ...
                <div class="bukti_seminar">
                    <div class="pl-3 pr-3 pb-0 mb-2 bg-light text-dark rounded-div">
                        ...
                        <div class="row border-bottom mt-2">
                            ...
                            <label class="col-md-3 bold mt-1"><strong>Nilai TA 2 Angka</strong></label>
                            <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                -
                            </div>
                        </div>
