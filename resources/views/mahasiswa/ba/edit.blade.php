                        ...
                        <div class="profile-edit-list row">
                            ...
                            <div class="weight-500 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input autofocus name="nilai_lapangan" id="nilai_lapangan" class="form-control"
                                        type="number" value="{{ old('nilai_lapangan', $seminar->nilai_lapangan) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus name="nilai_akhir" id="nilai_akhir" class="form-control" type="number"
                                        value="{{ old('nilai_akhir', $seminar->nilai_akhir) }}"
                                        placeholder="Masukkan Nilai">
                                    @error('nilai_akhir')
                                        <div class="form-control-feedback has-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="kanan weight-500 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input autofocus name="nilai_mutu" id="nilai_mutu" class="form-control" type="text"
                                        value="{{ old('nilai_mutu', $seminar->nilai_mutu) }}" placeholder="Masukkan Nilai">
                                    @error('nilai_mutu')
                                        <div class="form-control-feedback has-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input value="{{ old('berkas_ba_seminar_kp', $seminar->berkas_ba_seminar_kp) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <label> Berkas Laporan PKL/KP <small> <a id="link-berkas_ba_seminar_kp" href="#"
                                                target="_blank" style="display: none;">Lihat File</a> </small></label>
                                    <div class="custom-file">
                                        <label class="custom-file-label" for="link-laporan_kp" id="label-laporan_kp">Pilih
                                            File</label>
                                        <input value="{{ old('laporan_kp', $seminar->laporan_kp) }}" accept=".pdf"
                                            autofocus name="laporan_kp" id="file-laporan_kp"
