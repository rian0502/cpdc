        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-dark h4">Edit Data Seminar Tugas Akhir 1</h4>
                            <p class="mb-30">Isi data dengan benar</p>
                        </div>
                    </div>
                    <form action="{{ route('mahasiswa.sidang.kompre.update', $seminar->encrypt_id) }}" method="POST"
                                        ...
                                        <optgroup label="Pembimbing 1">
                                            @foreach ($dosens as $item)
                                                <option value="{{ $item->encrypt_id }}"
                                                    {{ old('id_pembimbing_satu',$seminar->pembimbingSatu->encrypt_id) == $item->encrypt_id ? 'selected' : '' }}>
                                ...
                                <div class="form-group" id="form-mobile">
                                    ...
                                    <div class="custom-control custom-checkbox mb-5">
                                        <input type="checkbox" class="custom-control-input" name="agreement"
                                            {{ old('agreement') ? 'checked' : '' }}} id="agreement" />
