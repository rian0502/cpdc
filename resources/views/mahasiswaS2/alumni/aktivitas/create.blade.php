        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-dark h4">Tambah Aktivitas</h4>
                            <p class="mb-30">Isi data dengan benar</p>
                        </div>
                    </div>
                    <form action="{{ route('mahasiswa.aktivitas_alumni_S2.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="hubungan" id="hubungan" class="selectpicker form-control" data-size="5"
                                        ...
                                        <option value="Sangat Erat"
                                            {{ old('hubungan') == 'Sangat Erat' ? 'selected' : '' }}>Sangat Erat
                                        </option>
                                        <option value="Erat"
                                            {{ old('hubungan') == 'Erat' ? 'selected' : '' }}>Erat
                                        </option>
                                        <option value="Cukup Erat"
                                            {{ old('hubungan') == 'Cukup Erat' ? 'selected' : '' }}>Cukup Erat
                                        </option>
                                        <option value="Tidak Erat"
                                            {{ old('hubungan') == 'Tidak Erat' ? 'selected' : '' }}>Tidak Erat
                                        </option>
                                    </select>
                                    @error('hubungan')
                                        <div class="form-control-feedback has-danger">{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="selectpicker form-control" data-size="5"
                                        ...
                                        <option value="Lainnya"
                                            {{ old('status') == 'Lainnya' ? 'selected' : '' }}>Lainnya
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="form-control-feedback has-danger">{{ $message }}</div>
