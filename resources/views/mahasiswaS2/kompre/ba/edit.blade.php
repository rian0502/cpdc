        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="{{ route('mahasiswa.bakompres2.update', $seminar->encrypt_id) }}" method="POST"
                        ...
                        <div class="profile-edit-list row">
                            ...
                            <div class="weight-500 col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Nomor Berita Acara Sidang Tesis</label>
                            ...
                            <div class="kanan weight-500 col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="mt-2"> Berkas Nilai Sidang Tesis <small> <a id="link-file_nilai"
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus name="pengesahan" id="pengesahan" class="form-control @error('pengesahan') form-control-danger @enderror" type="text"
                                        value="{{ old('pengesahan', $seminar->pengesahan) }}"
                    ...
                    <a href="{{ route('mahasiswa.sidang.kompres2.index') }}">
