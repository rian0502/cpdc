        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="{{ route('mahasiswa.bata1s2.update', $seminar->encrypt_id) }}" method="POST"
                        ...
                        <div class="profile-edit-list row">
                            ...
                            <div class="weight-500 col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Nomor Berita Acara Tesis 1</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select2 form-control @error('nilai_mutu') form-control-danger @enderror" name="nilai_mutu"
                                        ...
                                        <optgroup label="Huruf Mutu">
                                            ...
                                            <option
                                                value="AB"{{ old('nilai_mutu', $seminar->nilai_mutu) == 'AB' ? 'selected' : '' }}B>
                                                AB
                                            </option>
                                            <option
