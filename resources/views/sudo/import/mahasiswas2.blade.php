            ...
            <div class="min-height-200px">
                <div class="card-box mb-30">
                    <div class="pd-20">
                        ...
                        <a href="{{ route('sudo.import.mahasiswas2.unduh') }}" class="btn btn-success mt-4">Unduh Template Excel</a>
                    </div>
                    <div class="pb-20 m-3">
                        <form action="{{ route('sudo.import.mahasiswas2.store') }}" method="post" id="formStatus"
