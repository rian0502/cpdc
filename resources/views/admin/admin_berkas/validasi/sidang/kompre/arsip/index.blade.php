        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Arsip Sidang Komprehensif S1</h4>
                    </div>
                    <div class="pb-20 m-3">
    ...
    <script>
        $(function() {
            var dataNpm = $('.data-kompre').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('berkas.arsip_validasi.sidang.kompre.index') }}',
                    type: 'GET',
                },
                columns: [{
                        data: 'id',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            var editUrl = "{{ route('berkas.arsip_validasi.sidang.kompre.edit', ':id') }}".replace(
                                ':id', row.encrypt_id);
                            return `
