...
@section('datatable')
    ...
    <link rel="stylesheet" href="/Assets/setting/assets/css/demo.css" />
    ...
    <div class="main-container" >
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengaturan</h4>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                <img src="/Assets/setting/assets/img/avatars/1.png" alt="user-avatar" class="d-block rounded"
    ...
    <script src="/Assets/setting/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="/Assets/setting/assets/vendor/libs/popper/popper.js"></script>
    <script src="/Assets/setting/assets/vendor/js/bootstrap.js"></script>
    <script src="/Assets/setting/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
    <script src="/Assets/setting/assets/js/config.js"></script>
    <script src="/Assets/setting/assets/vendor/js/menu.js"></script>
    <script src="/Assets/setting/assets/js/main.js"></script>
    <script src="/Assets/setting/assets/js/pages-account-settings-account.js"></script>
@endsection
