        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Mahasiswa S2 Bimbingan Tugas Akhir</h4>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                    <a class="dropdown-item"
                                                        href="
                                                        {{-- INI JANGAN LUPA DI GANTI ROUTENYA --}}
                                                        {{ route('dosen.mahasiswa.bimbingan.kompre.show', $item->mahasiswa->npm) }}
                                                        "><i
                                                            class="dw dw-eye"></i>
                                                        View</a>
                                                </div>
