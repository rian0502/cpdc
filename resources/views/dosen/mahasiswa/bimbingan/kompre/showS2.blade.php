                        ...
                        <div class="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="ta1" role="tabpanel">
                                    <div class="pd-20">
                                        <div class="p-md-4">
                                            <h5 class="h4 text-blue mb-20">Data Seminar Tesis Satu</h5>
                                            @if ($seminarTa1 != null)
                                                <div class="p-3 mb-2 bg-light text-dark rounded-div">
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa1->pembahasSatu)
                                                                {{ $seminarTa1->pembahasSatu->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa1->pembahas_external_1 }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa1->pembahasDua)
                                                                {{ $seminarTa1->pembahasDua->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa1->pembahas_external_1 }}
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa1->pembahasTiga)
                                                                {{ $seminarTa1->pembahasTiga->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa1->pembahas_external_3 }}
                                                            @endif
                                                        </div>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="ta2" role="tabpanel">
                                    <div class="pd-20">
                                        <div class="p-md-4">
                                            <h5 class="h4 text-blue mb-20">Data Seminar Tesis Dua</h5>
                                            @if ($seminarTa2 != null)
                                                <div class="p-3 mb-2 bg-light text-dark rounded-div">
                                                    <div class="row border-bottom mt-3">
                                                        <label class="col-md-12 bold"><b>Judul atau Topik Tugas
                                                    ...
                                                    <div class="row border-bottom">
                                                        ...
                                                        <label class="col-md-3 bold mt-1"><strong>Pembimbing
                                                                2</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa2->pembimbingDua)
                                                                {{ $seminarTa2->pembimbingDua->nama_dosen }}
                                                            @else
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <label class="col-md-3 bold"> <strong>Pembahas 1</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa2->pembahasSatu)
                                                                {{ $seminarTa2->pembahasSatu->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa2->pembahas_external_1 }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <label class="col-md-3 bold"> <strong>Pembahas 2</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa2->pembahasDua)
                                                                {{ $seminarTa2->pembahasDua->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa2->pembahas_external_1 }}
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <label class="col-md-3 bold"> <strong>Pembahas 3</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa2->pembahasTiga)
                                                                {{ $seminarTa2->pembahasTiga->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa2->pembahas_external_3 }}
                                                            @endif
                                                        </div>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="kompre" role="tabpanel">
                                    <div class="pd-20">
                                        <div class="p-md-4">
                                            <h5 class="h4 text-blue mb-20">Data Seminar Tesis Tiga</h5>
                                            @if ($sidangKompre != null)
                                                <div class="p-3 mb-2 bg-light text-dark rounded-div">
                                                    ...
                                                    <div class="row border-bottom">
                                                        <label class="col-md-3 bold mt-2"><b>Pembimbing 1</b></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            {{ $seminarTa3->pembimbingSatu->nama_dosen }}
                                                        </div>
                                                        <label class="col-md-3 bold mt-1"><strong>Pembimbing
                                                                2</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa3->pembimbingDua)
                                                                {{ $seminarTa3->pembimbingDua->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa3->pbl2_nama }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row border-bottom">
                                                        ...
                                                        <div class="col-md-3 mt-2"
                                                            style="display:block;word-wrap:break-word;">
                                                            {{ $seminarTa3->tahun_akademik }}
                                                        </div>
                                                        <label class="col-md-3 bold mt-2"> <strong>Nomor Pegawai
                                                                Eksternal</strong></label>
                                                        <div class="col-md-3 mt-2"
                                                            style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa3->pbl2_nip)
                                                                {{ $seminarTa3->pbl2_nip }}
                                                            @else
                                                                -
                                                            @endif
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <label class="col-md-3 bold"> <strong>Pembahas 1</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa3->pembahasSatu)
                                                                {{ $seminarTa3->pembahasSatu->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa3->pembahas_external_1 }}
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <label class="col-md-3 bold"> <strong>Rencana
                                                                Seminar</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            {{ $seminarTa3->periode_seminar }}
                                                        </div>
                                                        <label class="col-md-3 bold"> <strong>Pembahas 2</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa3->pembahasDua)
                                                                {{ $seminarTa3->pembahasDua->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa3->pembahas_external_1 }}
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="row border-bottom mt-2">
                                                        ...
                                                        <label class="col-md-3 bold"> <strong>Pembahas 3</strong></label>
                                                        <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                                            @if ($seminarTa3->pembahasTiga)
                                                                {{ $seminarTa3->pembahasTiga->nama_dosen }}
                                                            @else
                                                                {{ $seminarTa3->pembahas_external_3 }}
                                                            @endif
                                                        </div>
                                                    </div>
