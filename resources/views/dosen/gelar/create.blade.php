        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="{{ route('dosen.gelar.store') }}" method="POST">
                        @csrf
                        <div class="profile-edit-list row">
                            ...
                            <div class="weight-500 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('instansi_pendidikan') }}" autofocus name="instansi_pendidikan"
                                ...
                                <div class="form-group">
                                    <label>Jurusan</label>
                                    <input value="{{ old('jurusan') }}" autofocus name="jurusan"
                                        id="jurusan"
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('tahun_lulus') }}" autofocus name="tahun_lulus"
                                        id="tahun_lulus"
                            ...
                            <div class="weight-500 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('nama_gelar') }}" autofocus name="nama_gelar"
                                        id="nama_gelar"
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('singkatan_gelar') }}" autofocus name="singkatan_gelar"
                                        id="singkatan_gelar"
