                        ...
                        <div class="profile-edit-list row">
                            ...
                            <div class="weight-500 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{old('nama_organisasi')}}" autofocus name="nama_organisasi" id="nama_organisasi"
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{old('tahun_menjabat')}}" autofocus name="tahun_menjabat" id="tahun_menjabat" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{old('tahun_berakhir')}}" autofocus name="tahun_berakhir" id="tahun_berakhir" 
