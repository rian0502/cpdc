        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="card-box mb-30">
                    ...
                    <div class="pb-20 m-3">
                        <div class="ml-3">
                            <form action="{{ route('koor.pra.jadwalTesis1.download') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3">
                            ...
                            <form action="{{ route('koor.pasca.jadwalTesis1.download') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                                    ...
                                                    @if ($item->jadwal)
                                                        <a class="dropdown-item"
                                                            href="{{ route('koor.jadwalTA1S2.edit', $item->encrypt_id) }}"><i
                                                                class="dw dw-edit2"></i>
                                                            Edit</a>
                                                        <a class="dropdown-item" href="{{ route('koor.jadwalTA1S2.resend', $item->encrypt_id) }}"><i class="dw dw-share"></i>
                                                            Kirim Kembali</a>
                                                    @else
                                                        <a class="dropdown-item" href="{{ route('koor.jadwalTA1S2.create', $item->encrypt_id) }}"><i
                                                                class="dw dw-calendar-1"></i>
                                                            Jadwalkan</a>
                                                    @endif
                                                </div>
                                            </div>
