            ...
            <div class="min-height-200px">
                ...
                @if ($seminar->jadwal)
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix" style="margin-bottom: 50px; margin-top: 10px;">
                            <div class="pull-left">
                                <h4 class="text-dark h4" style="margin-left: 10px">Jadwal Seminar Tesis 1</h4>
                            </div>
                        </div>
                        <div class="">
                            <div class="pl-3 pr-3 pb-0 mb-2 bg-light text-dark rounded-div">
                ...
                @if ($seminar->beritaAcara)
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix" style="margin-bottom: 50px; margin-top: 10px;">
                            <div class="pull-left">
                                <h4 class="text-dark h4" style="margin-left: 10px">Berita Acara Seminar Tesis 1</h4>
                            </div>
                        </div>
                        <div class="">
                            <div class="pl-3 pr-3 pb-0 mb-2 bg-light text-dark rounded-div">
                                ...
                                <div class="row border-bottom mt-2">
                                    ...
                                    <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                        <a target="_blank"
                                            href="/uploads/nilai_seminar_tesis_1/{{ $seminar->beritaAcara->file_nilai }}">Lihat
                                            Berkas</a>
                                    </div>
                                    <label class="col-md-3 bold mt-1"><strong>Berita Acara</strong></label>
                                    <div class="col-md-3" style="display:block;word-wrap:break-word;">
                                        <a target="_blank"
                                            href="/uploads/ba_seminar_tesis_1/{{ $seminar->beritaAcara->file_ba }}">Lihat
                                            Berkas</a>
                                    </div>
                                </div>
                            </div>
