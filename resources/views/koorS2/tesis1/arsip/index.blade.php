...
@section('datatable')
            ...
            <div class="min-height-200px">
                <div class="card-box mb-30">
                    ...
                    <div class="pb-20 m-3">
                        ...
                        <table id="data-tesis1" class="data-tesis1 table table-hover data-table-responsive stripe wrap">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
    ...
    <script>
        $(function() {
            var dataNpm = $('.data-tesis1').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                autoWidth: false,
                ajax: {
                    url: '{{ route('koor.arsip.tesis1.index') }}',
                    type: 'GET',
                },
                columns: [{
                        data: 'id',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var showUrl = "{{ route('koor.arsip.tesis1.show', ':id') }}".replace(
                                ':id', row.encrypt_id);
                            var editUrl = "{{ route('koor.arsip.tesis1.edit', ':id') }}".replace(
                                ':id', row.encrypt_id);
                            return `
                            <div class="dropdown">
