            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="pl-3 pr-3 pb-0 mb-2">
                        <form id="formStatus" action="{{ route('koor.arsip.sidang_tesis.update', $seminar->encrypt_id) }}"
                                ...
                                <div class="weight-500 col-md-6">
                                    ...
                                    @if ($seminar->beritaAcara)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="mt-2"> Berkas Nilai Tesis <small> <a
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input autofocus name="pengesahan" id="pengesahan" class="form-control @error('pengesahan') form-control-danger @enderror" type="text"
                                                    value="{{ old('pengesahan', $seminar->beritaAcara->pengesahan) }}"
