            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix" style="margin-bottom: 50px; margin-top: 10px;">
                        <div class="pull-left">
                            <h4 class="text-dark h4" style="margin-left: 10px">Edit Jadwal Sidang Tesis</h4>
                        </div>
                    </div>
                    <div class="pl-3 pr-3 pb-0 mb-2">
                        <form id="formJadwalUpdate"
                            action="{{ route('koor.jadwalKompreS2.update', $seminar->encrypt_id) }}" method="POST">
                            @method('PUT')
                            @csrf
