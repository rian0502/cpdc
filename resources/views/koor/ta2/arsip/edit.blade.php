            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="pl-3 pr-3 pb-0 mb-2">
                        <form id="formStatus" action="{{ route('koor.arsip.ta2.update', $seminar->encrypt_id) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input autofocus name="berkas_ppt_seminar_ta_dua" id="berkas_ppt_seminar_ta_dua"
                                                ...
                                                value="{{ old('berkas_ppt_seminar_ta_dua', $seminar->ba_seminar->berkas_ppt_seminar_ta_dua) }}"
                                ...
                                <div class="kanan weight-500 col-md-6">
                                    ...
                                    {{-- form untuk sebelah kanan --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" value="{{ $seminar->jadwal->jam_mulai_seminar_ta_dua }}"
                                                name="jam_mulai_seminar_ta_dua"
                                                class="form-control @error('jam_mulai_seminar_ta_dua') form-control-danger @enderror">
                                            @error('jam_mulai_seminar_ta_dua')
                                                <div class="form-control-feedback has-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            <label>Jam Selesai</label>
                                            <input type="time" name="jam_selesai_seminar_ta_dua"
                                                value="{{ $seminar->jadwal->jam_selesai_seminar_ta_dua }}"
                                                class="form-control @error('jam_selesai_seminar_ta_dua') form-control-danger @enderror">
                                            @error('jam_selesai_seminar_ta_dua')
                                                <div class="form-control-feedback has-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        @endif
