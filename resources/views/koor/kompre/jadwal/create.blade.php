                            ...
                            <div class="profile-edit-list row">
                                ...
                                <div class="weight-500 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('tanggal_sta2') }}" autofocus name="tanggal_sta2"
                                            id="tanggal_skp"
                                            class="form-control @error('tanggal_sta2') form-control-danger @enderror"
                                ...
                                <div class="kanan weight-500 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" value="{{ old('jam_mulai_sta2') }}" name="jam_mulai_sta2"
                                            class="form-control @error('jam_mulai_sta2') form-control-danger @enderror">
                                        @error('jam_mulai_sta2')
                                            <div class="form-control-feedback has-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label>Jam Selesai</label>
                                        <input type="time" name="jam_selesai_sta2" value="{{ old('jam_selesai_sta2') }}"
                                            class="form-control @error('jam_selesai_sta2') form-control-danger @enderror">
                                        @error('jam_selesai_sta2')
                                            <div class="form-control-feedback has-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
