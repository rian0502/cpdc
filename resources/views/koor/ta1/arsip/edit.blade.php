                                ...
                                <div class="weight-500 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            name="id_pembimbing_dua" id="id_pembimbing_dua"
                                            ...
                                            <optgroup label="Pembimbing 2">
                                                @foreach ($dosen as $item)
                                                    <option value="{{ $item->encrypt_id }}"
                                                        ...
                                                        {{ $item->nama_dosen }}</option>
                                                @endforeach
                                                @if (in_array(old('id_pembimbing_dua', $seminar->id_pembimbing_dua), ['new', null]) || $errors->has('pbl2_nama'))
                                    ...
                                    @if ($seminar->ba_seminar)
                                        <div class="form-group">
                                            ...
                                            <input autofocus name="nilai" id="nilai"
                                                ...
                                                type="text" value="{{ old('nilai', $seminar->ba_seminar->nilai) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input autofocus name="no_berkas_ba_seminar_ta_satu"
                                                id="no_berkas_ba_seminar_ta_satu"
                                                class="form-control @error('no_berkas_ba_seminar_ta_satu') form-control-danger @enderror"
                                                type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label> Berkas Berita Acara<small> <a id="link-berkas_ba_seminar_ta_satu"
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <input value="{{ old('berkas_ba_seminar_ta_satu') }}" accept=".pdf"
                                                        autofocus name="berkas_ba_seminar_ta_satu"
                                                        id="file-berkas_ba_seminar_ta_satu"
                                            ...
                                            <div class="form-group">
                                                <label class="mt-2"> Berkas Nilai Tugas Akhir 1 <small> <a
                                                            id="link-berkas_nilai_seminar_ta_satu" href="#"
                                                            target="_blank" style="display: none;">Lihat File</a>
                                                    </small></label>
                                                <div class="custom-file">
                                                    <label class="custom-file-label"
                                                        for="link-berkas_nilai_seminar_ta_satu"
                                                        id="label-berkas_nilai_seminar_ta_satu">Pilih
                                                        File</label>
                                                    <input value="{{ old('berkas_nilai_seminar_ta_satu') }}"
                                                        accept=".pdf" autofocus name="berkas_nilai_seminar_ta_satu"
                                                        id="file-berkas_nilai_seminar_ta_satu"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input autofocus name="berkas_ppt_seminar_ta_satu"
                                                    id="berkas_ppt_seminar_ta_satu"
                                                    class="form-control @error('berkas_ppt_seminar_ta_satu') form-control-danger @enderror"
                                                    type="text"
                                ...
                                <div class="kanan weight-500 col-md-6">
                                    ...
                                    @if ($seminar->jadwal)
                                        <div class="form-group">
                                            ...
                                            <input value="{{ $seminar->jadwal->tanggal_seminar_ta_satu }}" autofocus
                                                name="tanggal_seminar_ta_satu" id="tanggal_seminar_ta_satu"
