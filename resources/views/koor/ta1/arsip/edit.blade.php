            ...
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix" style="margin-bottom: 50px; margin-top: 10px;">
                        <div class="pull-left">
                            <h4 class="text-dark h4" style="margin-left: 10px">Jadwalkan Seminar TA 1 S1 </h4>
                        </div>
                    </div>
                            ...
                            <div class="profile-edit-list row">
                                <div class="weight-500 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autofocus name="tanggal_seminar_ta_satu" id="tanggal_seminar_ta_satu" class="form-control @error('tanggal_seminar_ta_satu') form-control-danger @enderror"
                                            type="date" value="{{ old('tanggal_seminar_ta_satu',$seminar->ba_seminar->seminar->jadwal->tanggal_seminar_ta_satu) }}" >
