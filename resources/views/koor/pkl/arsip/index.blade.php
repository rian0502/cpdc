        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Arsip Seminar PKL</h4>
                    </div>
                    <div class="pb-20 m-3">
    ...
    <script>
        $(function() {
            var dataNpm = $('.data-pkl').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('koor.arsip.pkl.index') }}',
                    type: 'GET',
                },
                columns: [{
                        data: 'id',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var showUrl = "{{ route('koor.arsip.pkl.show', ':id') }}".replace(
                                ':id', row.encrypt_id);
                            var editUrl = "{{ route('koor.arsip.pkl.edit', ':id') }}".replace(
                                ':id', row.encrypt_id);
                            return `
                            <div class="dropdown">
