...
class SeminarTaSatu extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('seminar_ta_satu', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('pembahas')->constrained('dosen')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        //
        Schema::dropIfExists('seminar_ta_satu');
    }
}
