...
class UpdateSeminarTesis1Request extends FormRequest
{
    /**
    ...
    {
        return Auth::user()->hasRole(['jurusan', 'ta1S2']);
    }
    ...
    public function messages()
    {
        return [
            ...
            'berkas_ta_satu.mimes' => 'Berkas tesis harus bertipe pdf',
            'berkas_ta_satu.max' => 'Berkas tesis maksimal 1 MB',
