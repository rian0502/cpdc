...
class UpdateBaTaDuaRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'berkas_ba_seminar_ta_dua' => 'nullable|mimes:pdf|max:1048',
            'berkas_nilai_seminar_ta_dua' => 'nullable|mimes:pdf|max:1048',
