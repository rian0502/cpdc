...
class StoreBaTaTesisRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'file_ba' => ['required', 'file', 'max:1048', 'mimes:pdf'],
            'file_nilai' => ['required', 'file', 'max:1048', 'mimes:pdf'],
        ];
    }
