...
class UpdateMahasiswaBaKpRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'berkas_ba_seminar_kp' => 'nullable|mimes:pdf|max:2048',
            'laporan_kp' => 'nullable|mimes:pdf|max:2048',
        ];
    }
    public function messages()
    {
        return [
            ...
            'nilai_lapangan.numeric' => 'Nilai Harus Angka, Jika Desimal Gunakan Titik (.)',
            ...
            'nilai_akd.numeric' => 'Nilai Harus Angka, Jika Desimal Gunakan Titik (.)',
            ...
            'nilai_akhir.numeric' => 'Nilai Harus Angka, Jika Desimal Gunakan Titik (.)',
