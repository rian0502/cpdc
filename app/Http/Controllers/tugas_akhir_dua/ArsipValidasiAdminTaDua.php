...
class ArsipValidasiAdminTaDua extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.admin_berkas.validasi.seminar.ta2.arsip.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.admin_berkas.validasi.seminar.ta2.arsip.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('berkas.arsip_validasi.seminar.ta2.index')->with('success', 'Berhasil Mengubah Data Seminar');
    }
