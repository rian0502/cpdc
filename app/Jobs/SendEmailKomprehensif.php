...
class SendEmailKomprehensif implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::send('email.jadwal_seminar', $this->data, function ($message) use ($to_name, $to_email, $namafile) {
            ...
            $message->attach('public/uploads/print_ba_kompre/' . $namafile);
        });
        unlink('public/uploads/print_ba_kompre/' . $namafile);
    }
}
